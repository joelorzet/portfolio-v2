...
interface IAptosIconProps extends IconProps {
    variant?: 'black' | 'white';
}

export function AptosIcon({ width = 48, height = 48, variant = 'white' }: IAptosIconProps) {
    const fill = variant === 'black' ? '#000000' : '#FFFFFF';

    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 60.47 60.7">
            <path
