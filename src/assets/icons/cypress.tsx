...
interface ICypressIconProps extends IconProps {
    variant?: 'black' | 'white';
}

export function CypressIcon({ width = 48, height = 48, variant = 'white' }: ICypressIconProps) {
    const fill = variant === 'black' ? '#000000' : '#FFFFFF';

    return (
        <svg fill={fill} width={width} height={height} viewBox="0 0 24 24" role="img">
